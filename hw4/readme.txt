...
Все данные генерировать рандомно в зависимости от граничных условий выше. Напиши программу, рассчитывающую, сколько электричества необходимо закупить (или можно продать) днем и ночью для обеспечения баланса и сколько это будет стоить (или принесет прибыли). Постарайся построить программу максимально модульно без лишних повторений.
